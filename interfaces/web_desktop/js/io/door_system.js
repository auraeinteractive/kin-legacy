...
//			let files = [ 'Developer\'s manual.pdf', 'DOS manual.pdf' ]; // not complete yet, 'User\'s guide.pdf' ]; 
	...
	dirList[ 'System:' + i18n( 'i18n_directory_Services' ) + '/' ]         = dirList[ 'System:Services/' ];
	...
	else if( path.toLowerCase() == 'system:' )
	{
		return callback( [
			...
			},
			{
				MetaType : 'Directory',
				Command  : 'Services',
				Title    : i18n( 'i18n_directory_Services' ),
				Permissions: '-r-e-,-r-e-,-r-e-',
				DateModified: dateh,
				Filesize: 16,
				Path     : 'System:Services/',
				PathLocalized: 'System:' + i18n( 'i18n_directory_Services' ),
				Type     : 'Directory',
				Module   : 'files',
				IconClass: 'System_Services',
				Door     : new DoorSystem( 'System:Services/' )
			},
			{
				MetaType : 'Directory',
